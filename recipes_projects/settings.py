"""
Django settings for recipes_projects project.
...
SECRET_KEY = 'h7p=-v1_p31v-)tr8dd5q6%ogg^8g+_%^v%$ophta5mzsrns8t'
...
ROOT_URLCONF = 'recipes_projects.urls'
...
WSGI_APPLICATION = 'recipes_projects.wsgi.application'
